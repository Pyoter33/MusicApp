...
class TrackUseCase @Inject constructor(private val musicPlayer: MusicPlayer) {

    var currentPosition: Int? = null

    suspend fun getTrackList(): List<Track> {
        return listOf(
            Track(1, "Track1", "Artist1", "3:01", "content://com.android.externalstorage.documents/document/primary%3ATracks%2FCalm.ogg"),
    ...
    fun onTrackChanged(path: String) {
        musicPlayer.initialize(path.toUri())
    }

    fun onTrackResumedPaused() {
        musicPlayer.onResumePause()
    }
